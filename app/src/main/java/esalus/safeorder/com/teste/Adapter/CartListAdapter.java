package esalus.safeorder.com.teste.Adapter;
...
import esalus.safeorder.com.teste.Helper.ManagementCart;
import esalus.safeorder.com.teste.Interface.ChangeNumberItemsListener;
...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.feeEacheItem.setText("$"+listFoodSelected.get(position).getFee());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView){
            ...
            feeEacheItem = itemView.findViewById(R.id.feeEachItem);
